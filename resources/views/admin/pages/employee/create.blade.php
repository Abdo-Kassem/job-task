...
@section('pageTitle') 
    <i class="fa fa-plus-circle"></i> اضافة موظف 
@endsection
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="job_title" id="job_title" class="form-control {{ $errors->has('job_title') ? 'is-invalid' : '' }}" value="{{ old('job_title') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="education" id="education" class="form-control {{ $errors->has('education') ? 'is-invalid' : '' }}" value="{{ old('education') }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="salary" id="salary" class="form-control {{ $errors->has('salary') ? 'is-invalid' : '' }}" value="{{ old('salary') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="birth_date" id="birth_date" class="form-control {{ $errors->has('birth_date') ? 'is-invalid' : '' }}" value="{{ old('birth_date') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:250px;height:200px;margin-top:5px;object-fit:contain" class="image-preview img-thumbnail" src="{{ asset('uploads/employees/default.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="text-center" style="margin-top:30px">
                            <button type="submit" class="btn btn-primary btn-block w-100" style="font-size:16px"><i class="fa fa-check fa-fw fa-lg"></i>حفظ</button>
                        </div>
                    </div>
